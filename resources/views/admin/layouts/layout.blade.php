    ...
    <nav id="sidebar" class="sidebar js-sidebar">
        <div class="sidebar-content js-simplebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item {{request()->routeIs('sub-category.create') ? 'active': ''}}">
                    <a class="sidebar-link" href="{{route('sub-category.create')}}">
                        <i class="align-middle" data-feather="plus"></i> <span class="align-middle">Create</span>
                    </a>
                </li>

                <li class="sidebar-item {{request()->routeIs('sub-category.manage') ? 'active': ''}}">
                    <a class="sidebar-link" href="{{route('sub-category.manage')}}">
                        <i class="align-middle" data-feather="list"></i> <span class="align-middle">Manage</span>
                    </a>
                </li>
                ...
                <ul class="navbar-nav navbar-align">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            @csrf
                                <input type="submit" value="Logout" class="btn btn-primary ms-3">
                            </form>
                        </div>
                    </li>
                </ul>
